...
function createActionsStore(): ActionsStore {
    ...
    async function initializeDefaultActions(): Promise<void> {
        ...
        const defaultActions: ActionCreateParams[] = [
            ...
            { id: 'cite', label: 'Cite', resourceEffect: 'no-change' },
            { id: 'transfer-all-rights', label: 'Transfer All Rights', resourceEffect: 'no-change' },
            { id: 'transfer-custody', label: 'Transfer Custody', resourceEffect: 'no-change' },
            { id: 'transfer', label: 'Transfer', resourceEffect: 'no-change' },
            { id: 'move', label: 'Move', resourceEffect: 'no-change' },
            { id: 'raise', label: 'Raise', resourceEffect: 'increment' },
            { id: 'lower', label: 'Lower', resourceEffect: 'decrement' }
        ];
